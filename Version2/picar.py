...
class Picar:
    def __init__(self):
        ...
        self.left_dir_a = DigitalOutputDevice(23)
        self.left_dir_b = DigitalOutputDevice(24)
        self.right_dir_a = DigitalOutputDevice(27)
        self.right_dir_b = DigitalOutputDevice(22)
        ...
        self.sensors = [
            ...
            DigitalInputDevice(26, pull_up=True),
        ]
        self.servo = 15
        ...
        self.servokit.servo[self.servo].set_pulse_width_range(
            min_pulse=650, max_pulse=2500
        )
